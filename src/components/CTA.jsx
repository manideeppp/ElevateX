import { FadeIn, ScaleIn } from './MotionPrimitives';
import { useMouseParallax } from '../hooks/useMouseParallax';
import { motion } from 'motion/react';

const WHATSAPP = '919515320303';
    ...
    <section className="cta-section" id="contact">
      <div className="cta-bg">
        <motion.div
          ...
          animate={{ x: mouse.x * 25, y: mouse.y * 15 }}
      ...
      <div className="container cta-content">
        ...
        <ScaleIn delay={0.3}>
          <div className="cta-actions">
            <a href="https://wa.me/919515320303" className="btn-primary btn-lg magnetic-btn" target="_blank" rel="noopener noreferrer">
            ...
            >
              ...
              <span>WhatsApp: +91 9515320303</span>
            </a>
          </div>
        </ScaleIn>
      </div>
